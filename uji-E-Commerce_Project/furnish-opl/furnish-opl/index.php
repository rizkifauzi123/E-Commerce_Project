...
?>
                ...
                <div class="col-lg-3 col-md-4">
                    <div class="collection-menu text-center mt-30">
                        ...
                        <div class="nav flex-column nav-pills" id="v-pills-tab" role="tablist" aria-orientation="vertical">
                            <a class="active" id="v-pills-furniture-tab" data-toggle="pill" href="#v-pills-furniture" role="tab" aria-controls="v-pills-furniture" aria-selected="true">Style Musim panas</a>
                                    ...
                                    <div class="col-md-4">
                                        <div class="single-product-items">
                                            <div class="product-item-image">
                                                <a href="#"><img src="assets/images/product/baju1.jpg" alt="Product"></a>
                                                <div class="product-discount-tag">
                                                    <p>-60%</p>
                                                </div>
                                            </div>
                                            <div class="product-item-content text-center mt-30">
                                                <h5 class="product-title"><a href="#">Musim Panas </a></h5>
                                                <ul class="rating">
                                                ...
                                                <span class="regular-price">Rp 250.000</span>
                                            </div>
    ...
    <!--====== FOOTER PART START ======-->
<?php 
    require_once "../furnish-opl/footer.php";  
?>
