                ...
                <nav class="sb-sidenav accordion sb-sidenav-dark" id="sidenavAccordion">
                    <div class="sb-sidenav-menu">
                        <div class="nav">
                            ...
                            <!-- <div class="sb-sidenav-menu-heading"></div> -->
                            <a class="nav-link" href="list_produk.php" data-bs-toggle="" data-bs-target="#Layouts" aria-expanded="false" aria-controls="collapseLayouts">
...
<div id="layoutSidenav_content">
    <main>
        <div class="container">
                    <a class="btn btn-success" href="form_produk.php" role="button" style="margin: 1em 0em 1em 0em;">Add Produk</a>
