...
<div id="layoutSidenav_content">
    <main>
        <div class="container">
                    <a class="btn btn-success" href="form_tipe.php" role="button" style="margin: 1em 0em 1em 0em;">Add Produk</a>
                    ...
                    <a class="btn btn-primary" href="../vendor/list_vendor.php" role="button">Vendor</a>  -->
                        <table class="table table-hover table-bordered" width="100%" border="1" cellspacing="2" cellpadding="2">
                            ...
                            <tbody>
                                ...
                                <a class="btn btn-danger" href="delete_tipe.php?iddel=<?=$row['id']?>"
                                onclick="if(!confirm('Anda Yakin Hapus Data Produk <?=$row['tipe']?>?')) {return false}">Delete</a>
                                </td>
                                </td>
                                        </tr>
                                    <?php 
